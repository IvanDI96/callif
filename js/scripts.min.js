...
$(function(){function t(){$(".voice .item-text p").height("auto").equalHeight(),$(".SMS .item-text p").height("auto").equalHeight(),$(".auto .item-text p").height("auto").equalHeight()}function e(){$(window).width()>993&&$(".sms-voice").css({height:.42*$(window).width()+"px"}),$(window).width()<993&&$(".sms-voice").css({height:1.425*$(window).width()+"px"})}e(),$(window).resize(function(){t(),e()}),t(),$(".title-wrap").animated("fadeIn"),$(".text-left").animated("slideInRight"),$(".text-right").animated("slideInLeft"),$("#form").submit(function(){var t=$(this);return $.ajax({type:"POST",url:"/mail.php",data:t.serialize()}).done(function(){alert("Спасибо за заявку!"),setTimeout(function(){t.trigger("reset")},1e3)}),!1});var i=$(".hamburger");i.on("click",function(t){i.toggleClass("is-active"),$(".toggle-mnu").toggleClass("is-open")}),$(".main-nav ul a").mPageScroll2id(),$(".button").mPageScroll2id(),$(".toggle-mnu ul a").on("click",function(t){i.toggleClass("is-active"),$(".toggle-mnu").toggleClass("is-open")}),$(".content").hide(),$(".content:first").show(),$("ul.tabs-list li").click(function(){$(".content").hide();var t=$(this).attr("rel");$("#"+t).fadeIn(),$("ul.tabs-list li").removeClass("active"),$(this).addClass("active"),$(".tab-content").removeClass("active")}),$(".tab-content").click(function(){$(".content").hide();var t=$(this).attr("rel");$("#"+t).fadeIn(),$(".tab-content").removeClass("active"),$(this).addClass("active"),$("ul.tabs li").removeClass("active"),$("ul.tabs li[rel^='"+activeTab+"']").addClass("active")})});